          ...
          <div className="flex justify-between h-16">
            ...
            <div className="hidden md:flex items-center space-x-8">
              <button 
                ...
                className={`${currentPage === 'home' ? 'text-indigo-600' : 'text-gray-600'} hover:text-indigo-500 px-3 py-2 rounded-md text-sm font-medium`}
              >
                Home
              </button>
              <button 
                onClick={() => setCurrentPage('about')} 
                className={`${currentPage === 'about' ? 'text-indigo-600' : 'text-gray-600'} hover:text-indigo-500 px-3 py-2 rounded-md text-sm font-medium`}
              >
                About
              </button>
              <button 
                onClick={() => setCurrentPage('contact')} 
                className={`${currentPage === 'contact' ? 'text-indigo-600' : 'text-gray-600'} hover:text-indigo-500 px-3 py-2 rounded-md text-sm font-medium`}
              >
                Contact
              </button>
              <button 
